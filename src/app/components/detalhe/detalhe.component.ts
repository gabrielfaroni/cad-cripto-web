...
export class DetalheComponent implements OnInit {
  ...
  //
  moedaDetalheHtml = {} as Moeda; // VARIAVEL DO TIPO MOEDA (AS ) as é comando do angular
  
  constructor(
    private service: EstagioService,
    private ActivatedRoute: ActivatedRoute
  ) {} // ActivateRoute é responsável por fazer interação com a rota, outra ferramenta do angular.
  ...
  ngOnInit(): void {
    ...
    this.service
      .obterMoedaPeloId(idMoeda) // como nosso id é number, colocamos lá number em service.
